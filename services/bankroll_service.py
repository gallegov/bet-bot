...
def update_bankroll(casa: str, delta_caja: float, delta_mes: float) -> dict:
    ...
    cell_a1 = gspread.utils.rowcol_to_a1(row, 1)
    cell_mes = gspread.utils.rowcol_to_a1(row, mes_col)
    ws.update([[nuevo_saldo]], cell_a1, value_input_option="RAW")
    ws.update([[nuevo_mes]], cell_mes, value_input_option="RAW")
